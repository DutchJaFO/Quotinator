...
/// <summary>Repository for <see cref="ImportBatchEntity"/> records, extending the base CRUD interface with batch-specific queries.</summary>
public interface IImportBatchRepository : IRepository<ImportBatchEntity>
{
    ...
    Task<IReadOnlyList<ImportBatchEntity>> GetAllAsync(IUnitOfWork? unitOfWork = null);
