...
/// <c>.../import/preview</c> into an <see cref="ImportSettingsDto"/>. Kept as a dedicated,
...
public static class ImportRequestSettingsParser
{
    ...
    /// </summary>
    public static bool TryParse(string? json, out ImportSettingsDto? settings)
    {
        ...
        try
        {
            settings = JsonSerializer.Deserialize<ImportSettingsDto>(json, Options);
            return true;
        }
        catch (JsonException)
        {
