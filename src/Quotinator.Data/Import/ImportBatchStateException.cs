...
/// isn't valid for the batch's current aggregate state — e.g. discarding a batch that holds applied
/// work, has already been discarded, has nothing left awaiting a decision, or has no staged actions at
/// all.
/// </summary>
