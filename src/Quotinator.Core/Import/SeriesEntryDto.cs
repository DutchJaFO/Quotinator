...
/// (#180). Widened by #163 to the same two-shape pattern <see cref="SourceEntryDto"/>/<see cref="PersonEntryDto"/>
...
/// </summary>
public sealed class SeriesEntryDto
{
    ...
    /// import time — never a raw id, same reasoning as <see cref="SourceEntryDto.SeriesName"/>.
    /// </summary>
