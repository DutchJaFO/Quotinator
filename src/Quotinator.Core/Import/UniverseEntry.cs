...
/// section (#180). Widened by #163 to the same two-shape pattern <see cref="SourceEntry"/>/
/// <see cref="PersonEntry"/> use: <see cref="Id"/> present → Correction, matched by that id;
