...
public interface IQuoteService
{
    ...
    /// <summary>Returns quotes whose text, source, character, or author contain <paramref name="query"/> (case-insensitive).</summary>
    IReadOnlyList<QuoteResponse> Search(string query, int limit, string? type = null, string? genre = null, string? lang = null);
}
