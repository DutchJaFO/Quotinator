...
/// <para>
/// One helper rather than the multi-argument construction repeated at every call site: a test that
...
public static class TestNotificationReader
{
    ...
    public static NotificationReader Create(IDbConnectionFactory factory)
        => new(factory,
            ...
            new JoinQueryRepository<NotificationEntity>(factory, new NotificationJoinStrategies.ByMetadataKind()));
