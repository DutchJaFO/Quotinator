...
internal static class AdminEndpoints
{
    internal static void MapAdminEndpoints(this WebApplication app)
    {
        ...
        .WithDescription(
            ...
            "Returns the quote count per file, plus a per-file, per-entity-type report (incoming/new/unchanged/resolvedToExisting/modified/blocked/discarded/pending/stale " +
        ...
        .WithDescription(
            ...
            "Returns the row counts and a per-file, per-entity-type report (incoming/new/unchanged/resolvedToExisting/modified/blocked/discarded/pending/stale counts) " +
