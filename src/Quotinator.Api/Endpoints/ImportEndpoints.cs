...
internal static class ImportEndpoints
{
    ...
    internal static void MapImportEndpoints(this WebApplication app)
    {
        ...
        const string ImportDescription =
            ...
            "`report` gives a per-entity-type incoming/new/unchanged/resolvedToExisting/skipped/modified/blocked/discarded/pending/stale action breakdown for this file (issue #221), " +
