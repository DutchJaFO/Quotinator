...
public class NumericParameterSchemaTransformerTests
{
    ...
    // -------------------------------------------------------------------------
    #region page/pageSize patched on masterdata/people (#186)

    [TestMethod]
    public async Task Page_OnMasterDataPeople_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("page", "api/v1/masterdata/people"));

    [TestMethod]
    public async Task PageSize_OnMasterDataPeople_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("pageSize", "api/v1/masterdata/people"));

    [TestMethod]
    public async Task Page_OnMasterDataPeople_PublishesDefaultOfOne()
        => Assert.AreEqual(1, (await TransformAndGetSchema("page", "api/v1/masterdata/people"))?.Default?.GetValue<int>());

    [TestMethod]
    public async Task PageSize_OnMasterDataPeople_PublishesDefaultOfTwenty()
        => Assert.AreEqual(20, (await TransformAndGetSchema("pageSize", "api/v1/masterdata/people"))?.Default?.GetValue<int>());

    #endregion

    // -------------------------------------------------------------------------
    #region page/pageSize patched on masterdata/series (#187)

    [TestMethod]
    public async Task Page_OnMasterDataSeries_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("page", "api/v1/masterdata/series"));

    [TestMethod]
    public async Task PageSize_OnMasterDataSeries_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("pageSize", "api/v1/masterdata/series"));

    [TestMethod]
    public async Task Page_OnMasterDataSeries_PublishesDefaultOfOne()
        => Assert.AreEqual(1, (await TransformAndGetSchema("page", "api/v1/masterdata/series"))?.Default?.GetValue<int>());

    [TestMethod]
    public async Task PageSize_OnMasterDataSeries_PublishesDefaultOfTwenty()
        => Assert.AreEqual(20, (await TransformAndGetSchema("pageSize", "api/v1/masterdata/series"))?.Default?.GetValue<int>());

    #endregion

    // -------------------------------------------------------------------------
    #region page/pageSize patched on conversations (#189)

    [TestMethod]
    public async Task Page_OnConversations_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("page", "api/v1/conversations"));

    [TestMethod]
    public async Task PageSize_OnConversations_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("pageSize", "api/v1/conversations"));

    [TestMethod]
    public async Task Page_OnConversations_PublishesDefaultOfOne()
        => Assert.AreEqual(1, (await TransformAndGetSchema("page", "api/v1/conversations"))?.Default?.GetValue<int>());

    [TestMethod]
    public async Task PageSize_OnConversations_PublishesDefaultOfTwenty()
        => Assert.AreEqual(20, (await TransformAndGetSchema("pageSize", "api/v1/conversations"))?.Default?.GetValue<int>());
    ...
    // -------------------------------------------------------------------------
    #region page/pageSize patched on masterdata/soundcues (#205)

    [TestMethod]
    public async Task Page_OnMasterDataSoundCues_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("page", "api/v1/masterdata/soundcues"));

    [TestMethod]
    public async Task PageSize_OnMasterDataSoundCues_PatchedToInteger()
        => Assert.AreEqual(Integer, await TransformAndGetType("pageSize", "api/v1/masterdata/soundcues"));

    [TestMethod]
    public async Task Page_OnMasterDataSoundCues_PublishesDefaultOfOne()
        => Assert.AreEqual(1, (await TransformAndGetSchema("page", "api/v1/masterdata/soundcues"))?.Default?.GetValue<int>());

    [TestMethod]
    public async Task PageSize_OnMasterDataSoundCues_PublishesDefaultOfTwenty()
        => Assert.AreEqual(20, (await TransformAndGetSchema("pageSize", "api/v1/masterdata/soundcues"))?.Default?.GetValue<int>());
