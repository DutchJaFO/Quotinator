...
/// this project's single canonical lowercase form, is idempotent, and rejects malformed input via
/// both a throwing and a non-throwing form. See #209/#210 — every entity canonicalizes to lowercase,
/// this project's final settled convention after two prior revisions.
/// </summary>
[TestClass]
public class EntityIdCanonicalizerTests
{
    ...
    {
        var result = EntityIdCanonicalizer.CanonicalizeLowercase("F0000190-0000-4000-8000-000000000001");
    ...
    {
        var succeeded = EntityIdCanonicalizer.TryCanonicalizeLowercase("F0000190-0000-4000-8000-000000000001", out var canonical);
