...
| 9 | ⬜ | T1 — local dev database (already at data v8/app v6) resets cleanly and boots against the squashed migration list | Live (T1) | Pending — developer to run in Visual Studio |
