...
| [#277](https://github.com/DutchJaFO/Quotinator/issues/277) | Gate startup backups on each action's own real-work signal, not an inferred flag; add a storage pre-flight check | In progress (step 1) | T1 ⬜ T2 ⬜ | [277-backup-gating-and-storage-preflight-plan.md](277-backup-gating-and-storage-preflight-plan.md) |
