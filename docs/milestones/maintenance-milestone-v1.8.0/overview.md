...
| [#244](https://github.com/DutchJaFO/Quotinator/issues/244) | Hidden Roslyn code-style and .NET analyzer diagnostics are invisible to the 0-warnings build policy (IDE0xxx, CAxxxx) | In progress | T1, T2 | [244-hidden-analyzer-diagnostics-plan.md](244-hidden-analyzer-diagnostics-plan.md) |
