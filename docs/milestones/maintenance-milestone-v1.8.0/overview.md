...
| [#280](https://github.com/DutchJaFO/Quotinator/issues/280) | Show a startup "please wait" page while the database is created/updated/seeded, with progress if feasible | In progress (step 2) | T1 ⬜ T2 ⬜ | [280-startup-wait-page-plan.md](280-startup-wait-page-plan.md) |
