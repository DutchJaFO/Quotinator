...
| [#263](https://github.com/DutchJaFO/Quotinator/issues/263) | Make recovering from critical startup/database errors easier (Blazor UI, HA add-on experience) | Planning | T1, T2 | [263-startup-ux-plan.md](263-startup-ux-plan.md) |
