...
| [#253](https://github.com/DutchJaFO/Quotinator/issues/253) | Rename Quotinator.Data-owned tables and entities to Import_/Audit_/System_ domains | Planning | T1, T2 | [253-data-owned-rename-plan.md](253-data-owned-rename-plan.md) |
