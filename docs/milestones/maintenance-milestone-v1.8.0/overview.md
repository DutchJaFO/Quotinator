...
| [#284](https://github.com/DutchJaFO/Quotinator/issues/284) | Migrate masterdata reference readers to JoinQueryRepository/IJoinStrategy, add missing integration tests | In progress | T1 ⬜ T2 ⬜ | [284-reference-reader-joinstrategy-migration-plan.md](284-reference-reader-joinstrategy-migration-plan.md) |
