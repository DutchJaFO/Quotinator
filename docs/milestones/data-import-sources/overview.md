...
| [#209](https://github.com/DutchJaFO/Quotinator/issues/209) | Canonicalize explicit ids at capture — Source, Person, StageDirection, SoundCue, Conversation (sub-issue of #207) | Planning | T1 ⬜ T2 ⬜ | [209-canonicalize-entity-ids-part-a-plan.md](209-canonicalize-entity-ids-part-a-plan.md) |
| [#210](https://github.com/DutchJaFO/Quotinator/issues/210) | Canonicalize Quotes.Id at capture, case-insensitive lookup (sub-issue of #207) | Planning | T1 ⬜ T2 ⬜ | [210-canonicalize-quote-id-plan.md](210-canonicalize-quote-id-plan.md) |
| [#207](https://github.com/DutchJaFO/Quotinator/issues/207) | Canonicalize file-authored explicit ids at capture (parent — closes once #209/#210 both close) | Planning | — (parent) | [207-canonicalize-entity-ids-plan.md](207-canonicalize-entity-ids-plan.md) |
...
#209 (canonicalize Source/Person/StageDirection/SoundCue/Conversation explicit ids at capture) → requires nothing; independent of #210 (both extend the same `EntityIdCanonicalizer` class but neither blocks the other); independent of #190 itself (a data-consistency bug, not an absent-vs-null bug), though found during its T2 pass
#210 (canonicalize Quotes.Id at capture, case-insensitive lookup) → requires nothing; independent of #209 for the same reason
...
| 52 | #209 | Canonicalize explicit ids at capture — Source, Person, StageDirection, SoundCue, Conversation (sub-issue of #207) | Planning |
| 53 | #210 | Canonicalize Quotes.Id at capture, case-insensitive lookup (sub-issue of #207) | Planning |
| 54 | #207 | Canonicalize file-authored explicit ids at capture (parent — closes once #209/#210 both close) | Planning |
