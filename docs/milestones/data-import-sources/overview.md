...
| [#140](https://github.com/DutchJaFO/Quotinator/issues/140) | Auto-update bundled sources from manifest URL | In progress | T1 ✅ (corruption bug found + fixed via converter plugins, 2026-07-04) T2 ⬜ | [140-auto-update-sources-plan.md](140-auto-update-sources-plan.md) |
