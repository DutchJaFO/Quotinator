...
| 53 | #210 | Canonicalize Quotes.Id at capture, case-insensitive lookup — scope expanded to a systemic `SqlIdCaseGuard` + `IdClauses` construction helper (sub-issue of #207) | Waiting for release |
