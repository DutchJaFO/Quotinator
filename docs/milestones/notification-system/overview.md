...
| [#309](https://github.com/DutchJaFO/Quotinator/issues/309) | Move changelog content to database-backed System_Changelog table | In progress (step 7) | TBD | [309-system-changelog-table-plan.md](309-system-changelog-table-plan.md) |
