...
| [#375](https://github.com/DutchJaFO/Quotinator/issues/375) | A quote from a multi-season TV series cannot say which season it is from | Planning | T1 ⬜ T2 ⬜ | [375-season-between-series-and-source-plan.md](375-season-between-series-and-source-plan.md) |
